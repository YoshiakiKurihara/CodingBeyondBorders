...
export default async function Experience_ReactTauri() {
  ...
  const posts = await getBlogPosts(process.env.NOTION_DISC_REACTTAURI_DATABASE_ID as string)
  return (
    <>
      <h1>{MessageText.TITLE_DISCUSSION_REACTTAURI}</h1>
...
/*   return (
    getBlogPosts(MessageText.TITLE_DISCUSSION_REACTTAURI, process.env.NOTION_DISC_REACTTAURI_DATABASE_ID as string)
  ) */
}
