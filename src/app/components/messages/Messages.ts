export const MessageText = {
    ...
    TITLE_PORTFOLIO_PYTHON :  'ポートフォリオ / Pythonについて',
    TITLE_PORTFOLIO_DOTNET :  'ポートフォリオ / .NET 開発について',
    TITLE_PORTFOLIO_NEXTJS :  'ポートフォリオ / Next.js 開発について',
    TITLE_PORTFOLIO_REACTNATIVE :  'ポートフォリオ / React Native開発について',
    TITLE_DISCUSSION_PYTHON :  '私のPython 開発について',
    TITLE_PORTFOLIO_REACTTAURI :  'ポートフォリオ / React/Tauri デスクトップ開発について',
