...
export default async function Portfolio_Python() {

  const posts = await getBlogPosts(process.env.NOTION_PORT_PYTHON_DATABASE_ID as string)
  return (
    <>
      <h1>{MessageText.TITLE_PORTFOLIO_PYTHON}</h1>
